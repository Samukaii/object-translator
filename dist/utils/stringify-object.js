...
exports.stringifyObject = exports.isObject = exports.isRegexp = exports.getOwnEnumerableKeys = void 0;
...
exports.getOwnEnumerableKeys = getOwnEnumerableKeys;
...
const stringifyObject = (input, options, pad = "") => {
    ...
    return (function stringify(input, options = {}, pad = '') {
        ...
        if ((0, exports.isObject)(input)) {
            let objectKeys = (0, exports.getOwnEnumerableKeys)(input);
            if (options.filter) {
